		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zjobworkchallan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zjobworkchallan-display": {
								"semanticObject": "zjobworkchallan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zjobworkchallan",
									"url": sap.ui.require.toUrl("zjobworkchallan")
								}
							}
						}
					}
